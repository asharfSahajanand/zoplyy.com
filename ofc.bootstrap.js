...
const GA_MEASUREMENT_ID = "G-WD76WX7SQ6";
...
function gtag_report_conversion(url) {
  ...
  gtag("event", "conversion", {
    send_to: "AW-17992114221/HN8jCK6x9YIcEK3Ap4ND",
    value: 0.1,
    currency: "AED",
...
(async function initDisplayAds() {
  ...
  const adSlots = [
    { adUnit: "/23330730517/zoplyy.com_d1", divId: "myw_top_1" },
    { adUnit: "/23330730517/zoplyy.com_d2", divId: "myw_top_2" },
    { adUnit: "/23330730517/zoplyy.com_d3", divId: "myw_top_3" },
  ];
